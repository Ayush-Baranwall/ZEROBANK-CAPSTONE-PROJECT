...
public class MoneyTransferPage {
    ...
    public MoneyTransferPage(WebDriver driver, ExtentTest test) {
        this.driver = driver;
    ...
    public boolean validateTransferFundSection() {
        ...
        try {
            ...
            ReportUtil.generateReport(driver, extentTest, Status.PASS, "Navigated to Transfer Fund Section");
        } catch (Exception e) {
            actResult = false;
            ReportUtil.generateReport(driver, extentTest, Status.FAIL,
    ...
    public boolean amountGiven(String amount) {
        ...
        try {
            ...
            ReportUtil.generateReport(driver, extentTest, Status.PASS, "Fund transfer successful");

        } catch (Exception e) {
            actResult = false;
            ReportUtil.generateReport(driver, extentTest, Status.FAIL, amount);
        }
    ...
    public boolean validateSuccessfulPayment() {
        ...
        try {
            ...
            ReportUtil.generateReport(driver, extentTest, Status.PASS, "Payment Successfull");
        } catch (Exception e) {
            actReasult = false;
            ReportUtil.generateReport(driver, extentTest, Status.FAIL, "Payment Unsuccessful");
        }
        return actReasult;
    }
}